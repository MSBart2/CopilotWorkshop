...
□ Testing        - Adequate coverage for the changes?
...
□ No PII in logs
□ Secrets from secure storage only
```
...
□ Leap years
□ Invalid dates
□ Date ranges spanning boundaries
```
...
└── Yes → Continue
    ...
    └── Yes → Continue
        ...
        ├── No (critical path) → Request changes
        ├── No (non-critical) → Suggest improvement
        └── Yes → Continue
            │
            Is it maintainable?
