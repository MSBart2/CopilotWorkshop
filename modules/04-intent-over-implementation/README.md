...
> **Core Philosophy**: Describe WHAT you want, not HOW to build it. The best developers articulate intent clearly and let AI translate that intent into implementation. In the age of AI assistance, clarity of thought matters more than knowledge of syntax.

## 📖 Overview

In Modules 02–03, you learned that clarity comes from **context** (what AI sees), **configuration** (how AI responds), and **documentation** (what AI learns from). Now you'll learn the most powerful skill: expressing **intent**—describing WHAT you want the code to do, without dictating HOW it should do it.

**The Intent Principle**: When you focus on WHAT (the business logic, the user outcome, the behavior) instead of HOW (the loops, the conditionals, the data structures), you unlock AI's ability to handle implementation details while you focus on the hard part: knowing what needs to be built.

## Prerequisites

- Modules 0–4 (Philosophy, context, configuration, documentation)
- Understanding of your project's domain and business requirements
...
By the end of this module, you will understand how **intent over implementation** transforms development:

- Express requirements in business terms, not technical instructions
- Use the CRISPE framework to structure high-level specifications
- Let AI handle boilerplate while you focus on business logic
- Write prompts that describe outcomes, not steps
- Iterate on intent rather than debugging syntax
- Recognize that clear thinking beats implementation knowledge

**Meta-Goal**: Understand that **the bottleneck is no longer "can you write the code?"—it's "do you know what to build?"** Intent clarity is the new essential skill.

---

## 🏛️ The Philosophy: What Matters More Than How
...
### Exercise 5: Tighten the Prompt — "Precision Through Structure"
...
**Priya** has been getting inconsistent results from Copilot. Sometimes the suggestions are perfect, sometimes they're way off. Her mentor suggests: "Your prompts are too vague. Let's tighten them."

#### 🎯 Objective

Turn a vague request into a precise, structured prompt.

#### 📋 Steps

1. Start with a vague prompt: "Make this faster"
2. Rewrite using the 4-part structure:
   - **Goal**: What outcome do you want?
   - **Constraints**: What must be preserved?
   - **Context**: What files/patterns apply?
   - **Output**: What form should the result take?
3. Run the improved prompt on a selected function
4. Compare results

#### ✅ Success Criteria

- [ ] Prompt includes Goal, Constraints, Context, Output
- [ ] Result is a small, safe change that matches your intent
- [ ] You can explain why the structured prompt worked better
...
_"Being specific gave me exactly what I needed. Vague prompts get vague results."_

---

### Exercise 6: Examples and Non-Examples — "Steering with Patterns"
...
**David** notices that Copilot sometimes suggests patterns he's been trying to eliminate from the codebase. "I need to teach it what good looks like," he realizes, "and what to avoid."

#### 🎯 Objective

Use positive and negative examples to steer Copilot's output style.

#### 📋 Steps

1. Find a good pattern in your repo (positive example)
2. Find a pattern you want to avoid (negative example)
3. Ask @workspace to refactor a function, providing both:
   ```
   Refactor this function.
   
   Follow this pattern (good): [paste example]
   Avoid this pattern (bad): [paste anti-pattern]
   ```
4. Verify the output against your team's patterns

#### ✅ Success Criteria

- [ ] Output mirrors the positive example style
- [ ] Output avoids the negative example pattern
- [ ] Result conforms to your repository conventions
...
_"This is how I encode architectural judgment into the prompt. The AI learns from examples, just like junior developers do."_
...
Continue to [Module 05: AI-Assisted Design Thinking](../05-ai-assisted-design-thinking/README.md) to learn how to use AI for problem decomposition, solution exploration, and architectural design.
